...
def collect_score(data_dir):
    ...
    plt.xlabel('degrees upper limit', fontsize=15)
    plt.ylabel('accuracy', fontsize=15)
    plt.xlim(40, 105)
    plt.ylim(0.4, 1.05)
    plt.xticks([j for j in range(5, 105, 5)], [j for j in range(5, 105, 5)], fontsize=10)
    plt.yticks([j / 100 for j in range(40, 105, 5)], [j / 100 for j in range(40, 105, 5)], fontsize=10)
    plt.title("accuracy under degree upper limit", fontsize=15)
    plt.grid()
