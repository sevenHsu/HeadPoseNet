...
class SqueezeNet(nn.Module):
    ...
    def __init__(self, version='1_1', num_classes=1000):
        ...
        self.fc_x = nn.Linear(512, self.num_classes)
        self.fc_y = nn.Linear(512, self.num_classes)
        self.fc_z = nn.Linear(512, self.num_classes)

        self.fc_top_x = nn.Linear(512, self.num_classes)
        self.fc_top_y = nn.Linear(512, self.num_classes)
        self.fc_top_z = nn.Linear(512, self.num_classes)
    ...
    def forward(self, x, pahse='train'):
        ...
        v_top_x = self.fc_top_x(x)
        v_top_y = self.fc_top_y(x)
        v_top_z = self.fc_top_z(x)
        ...
        return v_x, v_y, v_z, v_top_x, v_top_y, v_top_z
